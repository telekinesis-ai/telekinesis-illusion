...
def load_ccmaterials(
    folder_path: str = "resources/cctextures",
    used_assets: list = None,
    preload: bool = False,
    fill_used_empty_materials: bool = False,
    add_custom_properties: dict = None,
    use_all_materials: bool = False,
    skip_transparent_materials: bool = True,
) -> List[Material]:
    ...
    if os.path.exists(folder_path) and os.path.isdir(folder_path):
        ...
        for asset in os.listdir(folder_path):
            ...
            if os.path.isdir(current_path):
                ...
                if skip_transparent_materials and os.path.exists(
                    alpha_image_path
                ):
                    continue
                ...
                if preload:
                    ...
                    principled_bsdf.inputs["Alpha"].default_value = (
                        0 if os.path.exists(alpha_image_path) else 1
                    )
                ...
                _CCMaterialLoader.create_material(
                    new_mat,
                    base_image_path,
...
class _CCMaterialLoader:
    ...
    def create_material(
        ...
        metallic_node = MaterialLoaderUtility.add_metal(
            nodes, links, metallic_image_path, principled_bsdf
        )
