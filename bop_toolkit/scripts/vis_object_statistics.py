...
parser.add_argument(
    "--model_type",
    default=None,
    help="Type of object models to use. See dataset_params.py for options (e.g. cad, eval...). Default: None->'models' directory.",
)
parser.add_argument(
    "--datasets_path",
...
parser.add_argument(
    "--vis_dir",
    default=os.path.join(config.output_path, "vis_object_statistics"),
    help="Path to the folder for output visualisations.",
)
parser.add_argument(
    "--show", action="store_true", default=False, help="Show matplotlib plot."
)
...
dp_model = dataset_params.get_model_params(
    args.datasets_path, args.dataset, args.model_type
)
obj_models = {}
...
if args.show:
    ...
    save_path = (
        vis_dir
        / f"{args.dataset}_model_{args.model_type}_triangle_sizes_boxplot.png"
    )
