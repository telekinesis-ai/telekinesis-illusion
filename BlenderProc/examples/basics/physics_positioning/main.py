...
parser.add_argument(
    "spheres_obj",
    nargs="?",
    default="examples/basics/physics_positioning/active.obj",
    help="Path to the object file with sphere objects",
)
parser.add_argument(
    "ground_obj",
    nargs="?",
    default="examples/basics/physics_positioning/passive.obj",
    help="Path to the object file with the ground object",
)
parser.add_argument(
    "output_dir",
    nargs="?",
    default="examples/basics/physics_positioning/output",
...
bproc.camera.add_camera_pose(
    bproc.math.build_transformation_mat([0, -47.93, 16.59], [1.3, 0, 0])
)
...
bproc.object.sample_poses(spheres, sample_pose_func=sample_pose)
