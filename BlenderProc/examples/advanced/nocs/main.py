...
parser.add_argument(
    "shapenet_path",
    help="Path to the downloaded shape net core v2 dataset, get it from http://www.shapenet.org/",
)
parser.add_argument(
    "output_dir",
    nargs="?",
    default="examples/advanced/nocs/output",
...
for i in range(5):
    ...
    rotation_matrix = bproc.camera.rotation_from_forward_vec(
        shapenet_obj.get_location() - location
    )
