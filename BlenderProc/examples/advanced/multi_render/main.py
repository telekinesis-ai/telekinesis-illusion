...
parser.add_argument(
    "output_dir",
    nargs="?",
    default="examples/advanced/multi_render/output",
...
parser.add_argument(
    ...
    default=10,
    type=int,
    help="The number of times the objects should be repositioned and rendered using 2 to 5 random camera poses.",
)
