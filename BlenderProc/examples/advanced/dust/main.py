...
parser.add_argument(
    "model",
    nargs="?",
    default="resources/haven/models/ArmChair_01/ArmChair_01_2k.blend",
    help="ath to the blend file, from the haven dataset, browse the model folder, for all possible options",
)
parser.add_argument(
    "hdri_path",
    nargs="?",
    default="resources/haven",
    help="The folder where the `hdri` folder can be found, to load an world environment",
)
parser.add_argument(
    "output_dir",
    nargs="?",
    default="examples/datasets/haven/output",
