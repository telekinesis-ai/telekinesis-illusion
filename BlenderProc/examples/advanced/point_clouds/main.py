...
parser.add_argument(
    "scene",
    nargs="?",
    default="examples/resources/scene.obj",
    help="Path to the scene.blend file",
)
parser.add_argument(
    "output_dir",
    nargs="?",
    default="examples/advanced/point_clouds/output",
...
point_cloud = bproc.object.create_from_point_cloud(
    points, "point_cloud", add_geometry_nodes_visualization=True
)
