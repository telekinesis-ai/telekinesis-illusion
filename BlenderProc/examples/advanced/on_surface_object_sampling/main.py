...
parser.add_argument(
    "camera",
    nargs="?",
    default="examples/resources/camera_positions",
    help="Path to the camera file",
)
parser.add_argument(
    "scene",
    nargs="?",
    default="examples/advanced/on_surface_object_sampling/scene.blend",
    help="Path to the scene.blend file",
)
parser.add_argument(
    "output_dir",
    nargs="?",
    default="examples/advanced/on_surface_object_sampling/output",
...
spheres = bproc.object.sample_poses_on_surface(
    spheres, surface, sample_pose, min_distance=0.1, max_distance=10
)
