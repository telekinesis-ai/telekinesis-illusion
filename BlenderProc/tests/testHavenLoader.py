...
class UnitTestCheckHavenLoader(unittest.TestCase):
    def test_load_all_downloaded_haven_textures(self):
        ...
        """
        haven_textures_folder = os.path.join(
            test_path_manager.haven, "textures"
        )
        ...
        for texture_name in texture_names:
            if texture_name in textures_to_ignore:
                continue
            bproc.api.loader.load_haven_mat(
                haven_textures_folder, [texture_name]
            )
        ...
        assert_message = (
            f"Loaded {successes}/{total} Haven textures succesfully."
        )
    ...
    def test_new_random_haven_material(self):
        ...
        for used_asset in [None, ["terrain_red_01"]]:
            ...
            mat = bproc.loader.load_haven_mat(
                test_path_manager.haven,
