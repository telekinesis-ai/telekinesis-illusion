...
class DefaultConfig:
    ...
    # TODO: Currently not used, but might be good if introduced
    # The following are the default values in Blender
    pixel_filter = 1.5  # Lower values give more crisp renders, higher values are softer and reduce aliasing.
    use_fast_gi = False  # Trades of speed for accuracy/physical realism
